...
public class Wall {
    ...
    private domain.LikesInfo likesInfo; /*more info in the class*/
    private domain.Reposts reposts; /*more info in the class*/
    private String postType; /*information ab the way the note was created: post, copy, reply, postpone, suggest*/
    private domain.Geo geo; /*more info in the class*/
    ...
    public domain.Reposts getReposts() {
        return reposts;
    }

    public void setReposts(domain.Reposts reposts) {
